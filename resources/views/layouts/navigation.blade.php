...
>
  <div class="container-fluid w-full flex flex-row flex-wrap items-center justify-between px-6">
    <button
    ...
    <div class="collapse navbar-collapse flex flex-grow flex-row items-center" id="navbarSupportedContent1">
      <a class="text-xl text-white pr-2 font-semibold" href="#">LOGO</a>
      <!-- Left links -->
